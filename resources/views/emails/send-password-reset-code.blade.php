...
<table class="email-container" cellpadding="0" cellspacing="0" width="600">
    <tr>
        <td class="logo-container">
            <img src="http://localhost:8000/fairtrade-logo.png" alt="Company Logo" style="max-height: 80px;">
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="email-content">
            ...
            <p>You recently requested to reset your password. Please use the following code to proceed with your password reset:</p>
            <p class="reset-code">{{ $resetCode ?? '000000' }}</p>
